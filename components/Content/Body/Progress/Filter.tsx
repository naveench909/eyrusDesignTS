...
function Filter(props : FilterProps) {
    return (
        <div style={{height:"32px" , width :"122px" , backgroundColor:"#FFFFFF" , marginLeft: "8px" ,padding:'4px', border:'1px solid #D9D9D9' ,borderRadius:"4px" , display:'flex' , alignItems:"center"  , justifyContent:"space-between"}}>
            <span>Filter</span>
